...
class Huffman:
    ...
    def compress_img(self):
        ...
        print('75%')
        #print(encoded_img) #binary version
    ...
    def compress_text(self):
        ...
        with open(self.path, 'r+') as file, open(output_path, 'wb') as output:
            ...
            self.merge_nodes()
            self.make_codes()
            encoded_text = self.get_encoded_img(text)
            padded_encoded_text = self.pad_encoded_img(encoded_text)
    ...
    def decompress_img(self, input_path):
        ...
        with open(input_path, 'rb') as file, open(output_path, 'w') as output:
            ...
            #print(bit_string) #encoded binary number in string
    ...
    def decompress_text(self, input_path):
        filename, file_extension = os.path.splitext(self.path)
